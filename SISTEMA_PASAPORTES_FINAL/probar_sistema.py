...
def verificar_archivos():
    ...
    archivos_requeridos = [
        ...
        "CONFIG/config_desde_ejemplo_ISABELALVAREZRAMIREZ5@hotmail.com_Página_1_Imagen_0001.json",
...
def probar_configuracion():
    ...
    try:
        ...
        config_path = "CONFIG/config_desde_ejemplo_ISABELALVAREZRAMIREZ5@hotmail.com_Página_1_Imagen_0001.json"
...
def probar_fuentes():
    ...
    try:
        ...
        fuentes_dir = Path("TEMPLATE/Fuentes Extras")
        fuentes_requeridas = [
            "Arial.ttf",
